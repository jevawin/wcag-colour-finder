...
- [ ] 05-04-rebuild-markup-and-fonts-PLAN.md — Rebuild wave W1: new index.html skeleton matching mockup + Google Fonts (Inter + JetBrains Mono). Closes G1/G2/G6/G7/G10 markup.
